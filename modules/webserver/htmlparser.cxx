...
size_t Extractor::getNextOffset() const noexcept { return str.find(boundary, offset + 1); }

void Extractor::moveOffset() { offset = getNextOffset(); }

bool Extractor::isLastBoundary() const noexcept { return getNextOffset() != std::string::npos; }
...
HashTable<std::string, std::string> HTMLParser::parseFiles(const std::string &str) {
